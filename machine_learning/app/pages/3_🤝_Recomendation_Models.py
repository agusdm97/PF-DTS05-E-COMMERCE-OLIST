...
with tab1:
    ...
    with st.expander("Funcionamiento del modelo"):
        st.write(
            ...
            Utiliza un filtro de contenido teniendo en cuenta las características del producto y es especialmente 
