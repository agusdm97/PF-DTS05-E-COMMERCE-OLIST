...
1.2) Construir un modelo de visualización analítica que permita sistematizar y monitorear los distintos KPI's y métricas relevantes.
...
- #### Fidelidad del cliente (FC)
  ...
  - **Área:** Ventas
    ...
    - **Variables:**
      ...
      - N° total de clientes
    - **Fórmula:** $$FC =\frac{N°\ de\ clientes\ que\ volvieron\ a\ comprar}{N°\ total\ de\ compras}\times 100$$
