...
# ------------------------------------------------------------------------------#
   ...
   st.markdown("***")
   line_chart = (
    alt.Chart(marketing_volumen).mark_line().encode(
...
# ------------------------------------------------------------------------------#
   ...
   line_chart = (
    alt.Chart(cierre_volumen_lead).mark_line().encode(
        ...
        (fontSize=16).configure_axis(titleFontSize=14, labelFontSize=12)
    )
# ------------------------------------------------------------------------------#
